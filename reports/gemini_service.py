...
def get_gemini_client():
    ...
    if not key:
        print("DEBUG: Gemini API Key is EMPTY or NOT FOUND in settings!")
    else:
        print(f"DEBUG: Using Gemini API Key (first 10 chars): {key[:10]}...")
...
"""
        ...
        if '404' in str(e):
            try:
                # Debug: List available models to terminal
                print("DEBUG: 404 Error - Listing available models for your key:")
